...
data = np.load('/home/membio8/Methods_local/seqvec_files/hprd_seqvec_dict.npy', allow_pickle=True).tolist()

with open("/home/membio8/Methods_local/data/ppi/link", "r") as f:
    Lines = f.readlines()
    
with open("/home/membio8/Methods_local/S-VGAE/data/Hprd/proteinList.txt", "r") as f:
...
with open('/home/membio8/Methods_local/Node_Hprd_SeqVec_Moi.txt', 'w') as f:
    for line in Lines:        
